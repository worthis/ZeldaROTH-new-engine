...
void Monsters::initPage()
{
    ...
    case 0:
        ...
        if (scene->getMonsters(16) && !ennemis[16])
            ennemis[16] = (Ennemi *)(new Ennemi016(256 + 16, 112 + 12));
    ...
    case 1:
        ...
        if (scene->getMonsters(30) && !ennemis[30])
            ennemis[30] = (Ennemi *)(new Ennemi030(176 + 16, 112 + 12));
        ...
        if (scene->getMonsters(29) && !ennemis[29])
            ennemis[29] = (Ennemi *)(new Ennemi029(256 + 16, 176 + 11));
        break;
    case 2:
        ...
        if (scene->getMonsters(33) && !ennemis[33])
            ennemis[33] = (Ennemi *)(new Ennemi033(176 + 13, 48 + 12));
        if (scene->getMonsters(34) && !ennemis[34])
            ennemis[34] = (Ennemi *)(new Ennemi034(256 + 12, 48 + 12));
        if (scene->getMonsters(38) && !ennemis[38])
            ennemis[38] = (Ennemi *)(new Ennemi038(16 + 13, 112 + 12));
        if (scene->getMonsters(39) && !ennemis[39])
            ennemis[39] = (Ennemi *)(new Ennemi039(96 + 12, 112 + 12));
    ...
    case 3:
        if (scene->getMonsters(19) && !ennemis[19])
            ennemis[19] = (Ennemi *)(new Ennemi019(16 + 8, 48 + 8));
        if (scene->getMonsters(24) && !ennemis[24])
            ennemis[24] = (Ennemi *)(new Ennemi024(112 + 8, 40 + 8, false));
        if (scene->getMonsters(28) && !ennemis[28])
            ennemis[28] = (Ennemi *)(new Ennemi028(176 + 8, 48 + 4));
        if (scene->getMonsters(31) && !ennemis[31])
            ennemis[31] = (Ennemi *)(new Ennemi031(240 + 8, 48 + 8));
        if (scene->getMonsters(35) && !ennemis[35])
            ennemis[35] = (Ennemi *)(new Ennemi035(16 + 8, 112 + 8));
        if (scene->getMonsters(40) && !ennemis[40])
            ennemis[40] = (Ennemi *)(new Ennemi040(80 + 5, 108 + 8));
        if (scene->getMonsters(43) && !ennemis[43])
            ennemis[43] = (Ennemi *)(new Ennemi043(160 + 8, 112 + 8));
        if (scene->getMonsters(45) && !ennemis[45])
            ennemis[45] = (Ennemi *)(new Ennemi045(224 + 8, 104 + 6));
        if (scene->getMonsters(50) && !ennemis[50])
            ennemis[50] = (Ennemi *)(new Ennemi050(16 + 8, 176 + 6));
        break;
    }
}
...
bool Monsters::isPageEmpty(int p)
{
    ...
    {
    case 0:
        if (scene->getMonsters(4) || scene->getMonsters(53) || scene->getMonsters(11) || scene->getMonsters(12) || scene->getMonsters(10) || scene->getMonsters(9) || scene->getMonsters(8) || scene->getMonsters(1) || scene->getMonsters(6) || scene->getMonsters(5) || scene->getMonsters(16) || scene->getMonsters(15) || scene->getMonsters(3) || scene->getMonsters(13) || scene->getMonsters(14))
        {
            return false;
        }
        break;
    case 1:
        if (scene->getMonsters(18) || scene->getMonsters(26) || scene->getMonsters(21) || scene->getMonsters(27) || scene->getMonsters(32) || scene->getMonsters(22) || scene->getMonsters(30) || scene->getMonsters(23) || scene->getMonsters(42) || scene->getMonsters(37) || scene->getMonsters(41) || scene->getMonsters(29))
        {
            return false;
        }
        break;
    case 2:
        if (scene->getMonsters(2) || scene->getMonsters(25) || scene->getMonsters(33) || scene->getMonsters(34) || scene->getMonsters(38) || scene->getMonsters(39) || scene->getMonsters(44) || scene->getMonsters(46) || scene->getMonsters(47) || scene->getMonsters(48))
        {
            return false;
        }
        break;
    case 3:
        if (scene->getMonsters(19) || scene->getMonsters(24) || scene->getMonsters(28) || scene->getMonsters(31) || scene->getMonsters(35) || scene->getMonsters(40) || scene->getMonsters(43) || scene->getMonsters(45) || scene->getMonsters(50))
        {
            return false;
        }
        break;
