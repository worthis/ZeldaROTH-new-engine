...
void Map::launchRoom()
{
    ...
    { // indoor only
        ...
        case 12:
            ...
            if (bounds.getX() >= 320 && bounds.getX() <= 320 * 2 && bounds.getY() >= 240 && bounds.getY() <= 240 * 3)
            {
                bounds.setX(320);
                bounds.setY(240);
                bounds.setW(640);
        ...
        case 14:
            ...
            if ((bounds.getX() == 0 || bounds.getX() == 320 * 4 || bounds.getX() == 320 * 9) && bounds.getY() >= 240 * 2 && bounds.getY() <= 240 * 3)
            {
                bounds.setY(240 * 2);
                bounds.setH(480);
                break;
        ...
        case 16:
            ...
            if (bounds.getX() >= 320 * 3 && bounds.getX() <= 320 * 4 && bounds.getY() >= 240 * 3 && bounds.getY() <= 240 * 5)
            {
                bounds.setX(320 * 3);
                bounds.setY(240 * 3);
                bounds.setW(640);
        ...
        case 17:
            ...
            if (bounds.getX() <= 320 && bounds.getY() >= 240 * 7 && bounds.getY() <= 240 * 8)
            {
                bounds.setX(0);
                bounds.setY(240 * 7);
                bounds.setW(640);
            ...
            if (bounds.getX() >= 320 * 5 && bounds.getX() <= 320 * 6 && bounds.getY() >= 240 * 7 && bounds.getY() <= 240 * 8)
            {
                bounds.setX(320 * 5);
                bounds.setY(240 * 7);
                bounds.setW(640);
        ...
        case 18:
            ...
            if ((bounds.getX() == 0 || bounds.getX() == 320 * 4 || bounds.getX() == 320 * 5 || bounds.getX() == 320 * 9) && bounds.getY() >= 240 && bounds.getY() <= 240 * 3)
            {
                bounds.setY(240);
                bounds.setH(720);
                break;
            }
            if ((bounds.getX() == 320 || bounds.getX() == 320 * 2 || bounds.getX() == 320 * 6) && bounds.getY() >= 240 * 2 && bounds.getY() <= 240 * 3)
            {
                bounds.setY(240 * 2);
                bounds.setH(480);
                break;
        ...
        case 20:
            ...
            if ((bounds.getX() == 320 * 11 && bounds.getY() == 240) || (bounds.getX() == 320 * 10 && bounds.getY() == 240 * 2))
            {
            ...
            if ((bounds.getX() == 320 || bounds.getX() == 320 * 5 || bounds.getX() == 320 * 8 || bounds.getX() == 320 * 12) && bounds.getY() >= 240 * 4 && bounds.getY() <= 240 * 5)
            {
                bounds.setY(240 * 4);
                bounds.setH(480);
                break;
            }
            if ((bounds.getX() == 320 * 3 || bounds.getX() == 320 * 4 || bounds.getX() == 320 * 5 || bounds.getX() == 320 * 11) && bounds.getY() >= 240 && bounds.getY() <= 240 * 2)
            {
                bounds.setY(240);
                bounds.setH(480);
                break;
...
void Map::allumeTorche(int x, int y)
{
    ...
    case 14:
        ...
        if (((x == 143 || x == 156) && y == 26) || ((x == 147 || x == 152) && y == 18))
        {
            if (sol[143][26] == 1415 && sol[147][18] == 1415 && sol[152][18] == 1415 && sol[156][26] == 1415 && mur[149 * 2 + 1][13 * 2 + 1] == MUR)
            {
    ...
    case 17:
        ...
        if ((x == 77 && y == 17) || ((x == 62 || x == 77) && y == 27))
        {
            if (sol[77][17] == 1415 && sol[62][27] == 1415 && sol[77][27] == 1415 && mur[69 * 2 + 1][13 * 2 + 1] == MUR)
            {
        ...
        {
            if (sol[62][32] == 1415 && sol[77][32] == 1415 && sol[62][42] == 1415 && sol[77][42] == 1415 && mur[69 * 2 + 1][28 * 2 + 1] == MUR)
            {
        ...
        if ((x == 63 || x == 76) && y == 52)
        {
            if (sol[63][52] == 1415 && sol[76][52] == 1415 && mur[69 * 2 + 1][43 * 2 + 1] == MUR)
            {
        ...
        if ((x == 68 || x == 71) && y == 62)
        {
            if (sol[68][62] == 1415 && sol[71][62] == 1415 && mur[69 * 2 + 1][58 * 2 + 1] == MUR)
            {
        ...
        if ((x == 69 || x == 70) && y == 97)
        {
            if (sol[69][97] == 1415 && sol[70][97] == 1415 && mur[58 * 2 + 1][97 * 2] == MUR)
            {
        ...
        if (x == 62 && (y == 125 || y == 129))
        {
            if (sol[62][125] == 1415 && sol[62][129] == 1415 && mur[58 * 2 + 1][127 * 2] == MUR)
            {
        ...
        if (x == 77 && (y == 125 || y == 129))
        {
            if (sol[77][125] == 1415 && sol[77][129] == 1415 && mur[78 * 2 + 1][127 * 2] == MUR)
            {
        ...
        if ((x == 68 || x == 71) && y == 137)
        {
            if (sol[68][137] == 1415 && sol[71][137] == 1415 && mur[69 * 2 + 1][133 * 2 + 1] == MUR)
            {
        ...
        {
            if (sol[102][107] == 1415 && sol[137][107] == 1415 && sol[102][132] == 1415 && sol[137][132] == 1415 && mur[98 * 2 + 1][127 * 2] == MUR)
            {
...
bool Map::testInnerTransition(int x, int y)
{
    ...
    if (map == 20 && scene->getAvancement() < AV_ZELDA_SUIT && bounds.getX() == 320 * 10 && bounds.getY() == 240 && x >= bounds.getX() + bounds.getW() - 24 && bounds.getX() + bounds.getW() < w)
    {
    ...
    if (map == 20 && scene->getAvancement() == AV_ZELDA_SUIT && ((x <= bounds.getX() + 8 && bounds.getX() > 0) || (y <= bounds.getY() && bounds.getY() > 0) || (x >= bounds.getX() + bounds.getW() - 24 && bounds.getX() + bounds.getW() < w) || (y >= bounds.getY() + bounds.getH() - 32 && bounds.getY() + bounds.getH() < h)))
    {
...
bool Map::testTeleport(int x, int y)
{
    ...
    case 12:
        ...
        // escaliers
        if ((x == 9 * 16 + 8 && y == 36 * 16) || (x == 39 * 16 + 8 && y == 29 * 16) || (x == 69 * 16 + 8 && y == 36 * 16))
        {
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(12, x + 80 * 16, y + 24, S, false, false, true);
            AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
            return true;
        }
        if ((x == 89 * 16 + 8 && y == 36 * 16) || (x == 119 * 16 + 8 && y == 29 * 16) || (x == 149 * 16 + 8 && y == 36 * 16))
        {
    ...
    case 14:
        ...
        // escaliers
        if ((x == 109 * 16 + 8 && y == 6 * 16) || (x == 109 * 16 + 8 && y == 66 * 16) || (x == 149 * 16 + 8 && y == 36 * 16) || (x == 189 * 16 + 8 && y == 6 * 16) || (x == 189 * 16 + 8 && y == 66 * 16))
        {
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(14, x - 100 * 16, y + 24, S, false, false, true);
            AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
            return true;
        }
        if ((x == 9 * 16 + 8 && y == 6 * 16) || (x == 9 * 16 + 8 && y == 66 * 16) || (x == 49 * 16 + 8 && y == 36 * 16) || (x == 89 * 16 + 8 && y == 6 * 16) || (x == 89 * 16 + 8 && y == 66 * 16))
        {
    ...
    case 18:
        ...
        // escaliers
        if ((x == 129 * 16 + 8 && y == 21 * 16) || (x == 149 * 16 + 8 && y == 36 * 16) || (x == 169 * 16 + 8 && y == 21 * 16) || (x == 189 * 16 + 8 && y == 66 * 16))
        {
            MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(18, x - 100 * 16, y + 24, S, false, false, true);
            AudioManager::getInstance()->playSound(TS_ESCALIERS_DOWN);
            return true;
        }
        if ((x == 29 * 16 + 8 && y == 21 * 16) || (x == 49 * 16 + 8 && y == 36 * 16) || (x == 69 * 16 + 8 && y == 21 * 16) || (x == 89 * 16 + 8 && y == 66 * 16))
        {
...
void Map::testAnim(int x, int y, Direction dir)
{
    ...
    if (map >= 12 && map < 21)
    {
        ...
        if (scene->getCoffre(map - 11, 3))
        {
            ...
            {
            case 12:
                if (getSol(x, y + 7) == 1288 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 1292 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 1301 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 1307 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 13:
                if (getSol(x, y + 7) == 1538 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 1542 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 1551 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 1557 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 14:
                if (getSol(x, y + 7) == 1658 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 1660 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 1667 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 1672 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 15:
                if (getSol(x, y + 7) == 1822 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 1824 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 1831 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 1836 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 16:
                if (getSol(x - 1, y + 16) == 1968 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 1974 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 17:
                if (getSol(x - 1, y + 16) == 2107 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 2112 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 18:
                if (getSol(x, y + 7) == 2240 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 2242 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                break;
            case 19:
                if (getSol(x, y + 7) == 2369 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 2369 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 2378 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 2383 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                break;
            case 20:
                if (getSol(x, y + 7) == 2542 && dir == N)
                {
                    i = x / 16;
                    j = ((y + 7) / 16) - 3;
                }
                if (getSol(x, y + 24) == 2544 && dir == S)
                {
                    i = x / 16;
                    j = (y + 24) / 16;
                }
                if (getSol(x - 1, y + 16) == 2551 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 2556 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                if (getSol(x - 1, y + 16) == 2666 && dir == W)
                {
                    i = ((x - 1) / 16) - 3;
                    j = y / 16;
                }
                if (getSol(x + 16, y + 16) == 2671 && dir == E)
                {
                    i = (x + 16) / 16;
                    j = y / 16;
                }
                if (getSol(x, y + 7) == 2738 && dir == N)
                {
                    i = 210;
                    j = 24;
                }
            ...
            if (i != 0)
            {
                ...
                case 12:
                    if (bounds.getY() == 240 * 4)
                        k = 7;
                    else if (bounds.getY() == 240 && scene->getLink()->getY() < 240 * 2)
                        k = 8;
                    else
                        k = 9;
                    break;
                case 13:
                    if (bounds.getX() == 320 && bounds.getY() >= 240 * 4)
                        k = 9;
                    else if (bounds.getY() == 240 && scene->getLink()->getX() < 320 * 3)
                        k = 10;
                    else if (bounds.getX() == 320 * 2 && bounds.getY() >= 240 * 3 && scene->getLink()->getX() < 320 * 2 + 240)
                        k = 11;
                    else if (bounds.getY() == 240 * 5 && scene->getLink()->getX() >= 320 * 2 + 240)
                        k = 12;
                    else
                        k = 13;
                    break;
                case 14:
                    if (bounds.getX() == 0 && bounds.getY() < 240 * 4)
                        ...
                        k = 10;
                    else if (bounds.getY() == 0 && bounds.getX() < 320 * 3)
                        k = 11;
                    else if (bounds.getY() == 0 && bounds.getX() >= 320 * 3)
                        k = 12;
                    else
                ...
                case 17:
                    if (bounds.getY() == 240 * 7)
                        k = 7;
                    else if (bounds.getY() == 240 * 6 && scene->getLink()->getX() < 320 * 5 + 160)
                        k = 8;
                    else
                        k = 9;
                    break;
...
void Map::ouvrePorte(int x, int y, int type)
{
    ...
    case 7:
        ...
        sol[x][y + 1] = 930;
        sol[x + 1][y + 1] = 931;
        mur[x * 2 + 1][y * 2 + 1] = SABLE;
        mur[x * 2 + 2][y * 2 + 1] = SABLE;
        mur[x * 2 + 1][y * 2 + 2] = SABLE;
        mur[x * 2 + 2][y * 2 + 2] = SABLE;
        mur[x * 2 + 1][y * 2 + 3] = SABLE;
        mur[x * 2 + 2][y * 2 + 3] = SABLE;
        break;
    case 9:
        if (type == 0)
        {
    ...
    case 20:
        if (type == 0)
        {
            ...
            sol[x][y] = 2520 + offset;
            sol[x + 1][y] = 2521 + offset;
            sol[x][y + 1] = 2522 + offset;
            sol[x + 1][y + 1] = 2523 + offset;
            sol[x][y + 2] = 2514 + offset;
            sol[x + 1][y + 2] = 2515 + offset;
            sol[x][y + 3] = 2516 + offset;
            sol[x + 1][y + 3] = 2517 + offset;
            mur[x * 2 + 1][y * 2 + 1] = PIERRE;
            mur[x * 2 + 2][y * 2 + 1] = PIERRE;
            mur[x * 2 + 1][y * 2 + 2] = PIERRE;
            mur[x * 2 + 2][y * 2 + 2] = PIERRE;
...
int Map::getEtage()
{
    ...
    case 15:
        if (bounds.getX() < 100 * 16)
            return 0;
        if (bounds.getX() < 160 * 16)
            return 1;
        return 2;
    case 16:
        if (bounds.getX() < 20 * 16)
            return 0;
        if (bounds.getX() < 60 * 16)
            return -1;
        return -2;
    case 17:
    ...
    case 20:
        if (bounds.getX() < 20 * 16)
            return 1;
        if (bounds.getX() < 120 * 16)
            return 0;
        if (bounds.getX() < 160 * 16)
            return -1;
        return -2;
    case 21:
        if (bounds.getX() >= 20 * 16 && bounds.getY() == 45 * 16)
            return 0;
        return -1;
    case 22:
        if (bounds.getX() == 0 && bounds.getY() == 30 * 16)
            return -1;
        return 0;
    default:
        return 0;
