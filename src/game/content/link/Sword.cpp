...
bool Sword::hit(int offsetX, int offsetY, Direction dir, Animation anim, int step, int charge, int forceTotal) {
    ...
    if (anim == HIT_EPEE) {
        switch (dir) {
            case N :
                switch(step) {
                    case 0 : i=9; j=7; a=14; b=6; if (force > 3) { j=6; a=16; b=7;} break;
                    case 1 : i=9; j=-6; a=14; b=18; if (force > 3) { i=3; j=-13; a=22; b=24;} break;
                    case 2 : i=0; j=-8; a=16; b=16; if (force > 3) { j=-14; a=16; b=24;} break;
                    case 3 : i=-4; j=-6; a=14; b=14; if (force > 3) { i=-14; a=24; b=16;} break;
                    case 4 : i=-12; j=-6; a=14; b=22; if (force > 3) { i=-14; a=16;} break;
                    default : return false;
                }
                break;
            case S :
                switch(step) {
                    case 0 : i=-5; j=12; a=12; b=6; if (force > 3) { i=-7; j=14; a=14; b=8;} break;
                    case 1 : i=-6; j=12; a=14; b=14; if (force > 3) { i=-5; j=14; b=21;} break;
                    case 2 : i=0; j=21; a=16; b=12; if (force > 3) { j=20; b=19;} break;
                    case 3 : i=9; j=17; a=15; b=14; if (force > 3) { b=16;} break;
                    case 4 : i=16; j=15; a=12; b=14; if (force > 3) { a=14; b=13;} break;
                    default : return false;
                }
                break;
            case W :
                switch(step) {
                    case 0 : i=-2; j=1; a=6; b=12; if (force > 3) { i=-3; j=-1; a=8; b=14;} break;
                    case 1 : i=-10; j=0; a=12; b=14; if (force > 3) { i=-14; a=18; b=14;} break;
                    case 2 : i=-13; j=0; a=16; b=16; if (force > 3) { i=-20; a=24; b=20;} break;
                    case 3 : i=-12; j=13; a=14; b=10; if (force > 3) { i=-14; j=12; a=16; b=18;} break;
                    case 4 : i=-7; j=16; a=14; b=18; if (force > 3) { i=-9; j=16; a=16; b=19;} break;
                    default : return false;
                }
                i += 2;
                break;
            case E :
                switch(step) {
                    case 0 : i=12; j=1; a=6; b=12; if (force > 3) { i=11; j=-1; a=8; b=14;} break;
                    case 1 : i=14; j=0; a=12; b=14; if (force > 3) { i=12; a=18; b=14;} break;
                    case 2 : i=13; j=0; a=16; b=16; if (force > 3) { i=12; a=24; b=20;} break;
                    case 3 : i=14; j=13; a=14; b=10; if (force > 3) { i=14; j=12; a=16; b=18;} break;
                    case 4 : i=9; j=16; a=14; b=18; if (force > 3) { i=9; j=16; a=16; b=19;} break;
                    default : return false;
                }
                i -= 2;
                break;
        ...
        switch (dir) {
            case N : i = 4; j = -2; a = 8; b = 12;
                if (move && step2) j++;
                if (force > 3) {i -= 2; j -= 2; b = 15;} break;
            case S : i = 8; j = 19; a = 8; b = 12;
                if (move && step2) j++;
                if (force > 3) {i--; b = 14;} break;
            case W : i = -8; a = 12; b = 8; j = 14;
                if (move && step2) j++;
                if (force > 3) {i -= 3; a = 15;} break;
            case E : i = 12; a = 12; b = 8; j = 14;
                if (move && step2) j++;
                if (force > 3) a = 15; break;
        }
...
void Sword::drawHit(int dstX, int dstY, Direction dir, int step) {
    ...
    switch (dir) {
        case N :
            switch(step) {
                case 0 : dstX += 11; dstY += 7; if (force > 3) {dstX += 2; dstY--;} break;
                case 1 : dstX += 8; dstY -= 6; if (force > 3) {dstX -= 5; dstY -= 7;} break;
                case 2 : dstY -= 8; if (force > 3) dstY -= 7; break;
                case 3 : dstX -= 4; dstY -= 6; if (force > 3) dstX -= 10; break;
                case 4 : dstX -= 12; dstY ++; if (force > 3) {dstX -= 2; dstY++;} break;
            }
            break;
        case S :
            switch(step) {
                case 0 : dstX -= 5; dstY += 12; if (force > 3) {dstX -= 2; dstY += 2;} break;
                case 1 : dstX -= 6; dstY += 12; if (force > 3) {dstX++; dstY += 7;} break;
                case 2 : dstX += 9; dstY += 21; if (force > 3) dstY--; break;
                case 3 : dstX += 10; dstY += 17; if (force > 3) dstX += 4; break;
                case 4 : dstX += 16; dstY += 15; break;
            }
            break;
        case W :
            switch(step) {
                case 0 : dstX -= 0; dstY += 1; if (force > 3) {dstX--; dstY -= 2;} break;
                case 1 : dstX -= 10; if (force > 3) {dstX -= 4; dstY++;} break;
                case 2 : dstX -= 13; dstY += 13; if (force > 3) {dstX -= 7; dstY--;} break;
                case 3 : dstX -= 12; dstY += 16; if (force > 3) dstX -= 2; break;
        ...
        case E :
            switch(step) {
                default :
                case 0 : dstX += 9; dstY += 1; if (force > 3) {dstX += 4; dstY -= 2;} break;
                case 1 : dstX += 14; if (force > 3) dstY++; break;
                case 2 : dstX += 15; dstY += 13; if (force > 3) dstY--; break;
    ...
    switch (dir) {
        case N :
            switch (step) {
                case 0 : case 5 : case 21 : case 22 : case 23 : case 24 : case 25 : case 26 :
                    ...
                    if (force > 3) {dstX--; srcX = 94; srcY = 14;}
                    break;
                case 1 : case 2 : case 3 : case 4 :
                    dstX += 3; dstY += 20; srcX = 56; srcY = 12;
                    if (force > 3) {srcX = 80; srcY = 14;}
                    break;
                case 6 :
                    dstX -= 12; dstY += 15; srcX = 56; srcY = 24;
                    if (force > 3) {dstX -= 2; srcX = 80; srcY = 28;}
                    break;
                case 7 : case 8 :
                    dstX -= 12; dstY += 8; srcX = 56; srcY = 36;
                    if (force > 3) {dstX -= 2; dstY--; srcX = 80; srcY = 42;}
                    break;
                case 9 : case 10 :
                    dstX++; dstY -= 4; srcX = 68; srcY = 0;
                    if (force > 3) {dstX--; dstY-=2; srcX = 94; srcY = 0;}
                    break;
                case 11 : case 12 :
                    dstX += 10; dstY -= 4; srcX = 56; srcY = 0;
                    if (force > 3) {dstY -= 2; srcX = 80; srcY = 0;}
                    break;
                case 13 : case 14 :
                    dstX += 16; dstY += 8; srcX = 68; srcY = 36;
                    if (force > 3) {dstY--; srcX = 94; srcY = 42;}
                    break;
                case 15 : case 16 :
                    dstX += 16; dstY += 16; srcX = 68; srcY = 24;
                    if (force > 3) {srcX = 94; srcY = 28;}
                    break;
                case 17 : case 18 :
        ...
        case S :
            switch (step) {
                ...
                case 17 : case 18 :
                    dstX++; dstY -= 4; srcX = 68; srcY = 0;
                    if (force > 3) {dstX--; dstY -= 2; srcX = 94;}
                    break;
                case 19 : case 20 :
                    dstX += 10; dstY -= 4; srcX = 56; srcY = 0;
                    if (force > 3) {dstY -= 2; srcX = 80;}
                    break;
            }
            break;
        case W :
            switch (step) {
                ...
                case 13 : case 14 :
                    dstX++; dstY -=4; srcX = 68; srcY = 0;
                    if (force > 3) {dstX--; dstY -= 6; srcX = 94;}
                    break;
                case 15 : case 16 :
                    dstX += 10; dstY -= 4;srcX = 56; srcY = 0;
                    if (force > 3) {dstY-=2; srcX = 80;}
...
void Sword::drawCharge(int dstX, int dstY, Direction dir, bool move, int step, int charge) {
    ...
    switch (dir) {
        case N : dstX += 4; srcW = 8; srcH = 12; dstY -= 2;
            if (move && step) dstY++;
            if (force > 3) {dstX -= 2; dstY -= 2; srcH = 15;} break;
        case S : dstX += 8; srcW = 8; srcH = 12; dstY += 19;
            if (move && step) dstY++;
            if (force > 3) {dstX--; srcH = 14;} break;
        case W : dstX -= 8; srcW = 12; srcH = 8; dstY += 14;
            if (move && step) dstY++;
            if (force > 3) {dstX -= 3; srcW = 15;} break;
        case E : dstX += 12; srcW = 12; srcH = 8; dstY += 14;
            if (move && step) dstY++;
            if (force > 3) srcW = 15; break;
    }
    ...
    if (charge < 19) {
        ...
        switch (dir) {
            case N : dstX -= 2; dstY -= 5; if (force > 3) dstX += 4; break;
